namespace GILL_BLOG.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GILL_BLOG.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Models.ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any(p => p.UserName == "rajdeepgill98@yahoo.com"))
            {
                ...
                adminUser.Email = "rajdeepgill98@yahoo.com";
            ...
            {
                adminUser = context.Users.Where(p => p.UserName == "rajdeepgill98@yahoo.com")
                    .FirstOrDefault();
            }
